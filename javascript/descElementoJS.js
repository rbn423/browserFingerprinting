var descripcionesJS = {
    ...
    "plataforma" : "Indica para qué plataforma está compilado el navegador",
    ...
    "onLine" : "Indica si el navegador está en línea o no",
    "appName" : "Indica el nombre del navegador. Por lo general todos los navegadores modernos retornan el valor 'Netscape'",
    "bateria" : "Indica si se puede acceder a la información de la batería",
    "DNTJS" : "Indica la preferencia de seguimiento del usuario",
    "touchpoints" : "Máximo de puntos táctiles en contacto simultáneamente soporta el dispositivo actual",
    "product" : "Motor de navegación",
    "productSub" : "Número de compilación del navegador actual",
    ...
    "screenWidth" : "Ancho de la pantalla del usuario en píxeles",
    "screenHeight" : "Alto de la pantalla del usuario en píxeles" ,
    "screenAvailWidth" : "Ancho de la pantalla del usuario en píxeles, a excepción de los elementos de interfaz como la barra de tareas",
    "screenAvailHeight" : "Alto de la pantalla del usuario en píxeles, a excepción de los elementos de interfaz como la barra de tareas",
    "screenColorDepth" : "Número de bits utilizados para definir un color",
    "screenPixelDepth" : "Número de bits utilizados para definir la profundidad de píxeles de la pantalla",
    ...
    "video" : "Comprobamos la disponibilidad del códec para el formato de video. Puede ser Probably, Maybe o vacía",
    "audio" : "Comprobamos la disponibilidad del códec para el formato de audio. Puede ser Probably, Maybe o vacía",
    "fuentes" : "Comprobamos qué fuentes instaladas en el navegador coinciden con una lista de fuentes declarada por nosotros"
};
