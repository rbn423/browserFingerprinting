...
"Las opciones actuales de los usuarios para mitigar estas amenazas son limitadas, en parte debido a la dificultad de distinguir las rastreando desde el comportamiento benigno" (\cite{never_forget_paper}: \texit{The Web Never Forgets: Persistent Tracking Mechanisms in the Wild}). \par 
