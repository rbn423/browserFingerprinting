...
<body>
	...
	<script>
		...
		salida += "- Nombre en codigo de la app = " + navigator.appName + "<br/>" ; // appName, appCodeName y appVersion devuelven el mismo valor
...
<script type="text/javascript">
	...
	document.getElementById("fuentes").innerHTML=txt;
</script>
